...
def main():
    ...
    pass
    print(f'{len(digits[5].valid_inputs)} : Valid inputs to check against e_out')
            ...
            for c in range(1,10):
                ...
                for d in range(1,10):
                    ...
                    for e in range(1,10):
                        ...
                        if e_out in digits[5].valid_inputs:
                            for f in range(1,10):
                                f_out = digits[5].attempt(f, e_out)
                                if f_out in digits[6].valid_inputs:
                                    for g in range(1,10):
                                        g_out = digits[6].attempt(g, f_out)
                                        if g_out in digits[7].valid_inputs:
                                            for h in range(1,10):
