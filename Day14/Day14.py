...
def main():
    ...
    my_polymer.run_insertion_steps(40)
    my_polymer.count_monomers()
    my_polymer.calculate_min_max()
    print(f'Highest = {my_polymer.highest}: {my_polymer.monomer_count[my_polymer.highest]}')
    print(f'Lowest = {my_polymer.lowest}: {my_polymer.monomer_count[my_polymer.lowest]}')
